            ...
            Column(
                ...
                LazyColumn(
                    ...
                    items(historyViewModel.historyUIState.listContent) { item ->
                        ...
                        when (bulan) {
                            "1" -> convertedBulan = "Januari"
                            "2" -> convertedBulan = "Februari"
                            "3" -> convertedBulan = "Maret"
                            "4" -> convertedBulan = "April"
                            "5" -> convertedBulan = "Mei"
                            "6" -> convertedBulan = "Juni"
                            "7" -> convertedBulan = "Juli"
                            "8" -> convertedBulan = "Agustus"
                            "9" -> convertedBulan = "September"
