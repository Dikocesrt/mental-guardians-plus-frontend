...
@Composable
fun FirstOnBoardScreen(navigateToSecondScreen: () -> Unit, navigateToThirdScreen: () -> Unit){
    Column(
        modifier = Modifier.fillMaxSize().background(Color.White),
    ) {
        Spacer(modifier = Modifier.height(32.dp))
        Image(
            painter = painterResource(id = R.drawable.first_onboard),
        ...
        Image(
            painter = painterResource(id = R.drawable.first_slidebar),
        ...
        Row(
            ...
            TextButton(onClick = { navigateToSecondScreen() }, modifier = Modifier.padding(0.dp)) {
                Text(
                    text = "Berikutnya",
                    fontFamily = poppinsFontFamily,
                    fontWeight = FontWeight.Normal,
